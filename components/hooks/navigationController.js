    ...
    return (
        <NavigationContainer >
            <Stack.Navigator >
                ...
                <Stack.Screen options={{ headerLargeTitle: false, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: false, headerShadowVisible: false, animation: 'default' }} name='MyCart' component={Cart} />
                <Stack.Screen options={{ headerLargeTitle: false, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: false, headerShadowVisible: false, animation: 'default' }} name='MapDirections' component={Maps} />
                <Stack.Screen options={{ headerLargeTitle: false, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: false, headerShadowVisible: true, animation: 'default' }} name='Pharmacy' component={Pharmacy} />
                <Stack.Screen options={{ headerLargeTitle: false, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: false, headerShadowVisible: true, animation: 'default' }} name='Doctors' component={Doctors} />
                <Stack.Screen options={{ headerLargeTitle: false, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: false, headerShadowVisible: true, animation: 'default' }} name='Labs' component={Labs} />
                <Stack.Screen options={{ headerLargeTitle: true, headerShown: true, headerLargeTitleStyle: { fontSize: '28px', fontWeight: 'lighter' }, headerTransparent: true, headerShadowVisible: true, animation: 'default' }} name='Settings' component={settings} />
            </Stack.Navigator>
        </NavigationContainer>
    )
}
