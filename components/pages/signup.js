    ...
    return (
        <View className="container h-full bg-white">
            ...
            <View className='w-full  justify-center items-center py-5'>
                <Text style={`${Platform.OS == "ios" && fontFamily.BHeading}`} className="text-3xl ">Welcome To</Text>
                            ...
                            {({ handleChange, handleBlur, handleSubmit, values }) => (
                                <View>
                                    ...
                                    <TouchableOpacity onPress={handleSubmit} className=" bg-purple-400 rounded-md mx-auto px-[135px] py-1 my-8 drop-shadow-2xl justify-center items-center">
                                        <Text style={`${Platform.OS == "ios" && fontFamily.mediumHeading}`} className="text-2xl text-white">Sign Up</Text>
                                    </TouchableOpacity>

                                    <View className="w-full flex flex-row justify-center items-center  inset-x-0 bottom-0 h-16">
                                        <Text style={`${Platform.OS == "ios" && fontFamily.mediumHeading}`} className="text-lg">Join us before? <TouchableOpacity onPress={() => { navigation.navigate('Login') }} ><Text style={`${Platform.OS == "ios" && fontFamily.mediumHeading}`} className="underline text-xl">Login</Text></TouchableOpacity></Text>
                                    </View>
                        ...
                        >
                            {({ handleChange, handleBlur, handleSubmit, values }) => (
                                <View>
                                    ...
                                    <View className="w-full flex flex-row justify-center items-center  inset-x-0 bottom-0 h-16">
                                        <Text style={`${Platform.OS == "ios" && fontFamily.mediumHeading}`} className="text-lg">Join us before? <TouchableOpacity onPress={() => { navigation.navigate('Login') }} ><Text style={`${Platform.OS == "ios" && fontFamily.BHeading}`} className="underline text-xl">Login</Text></TouchableOpacity></Text>
                                    </View>
                                </View>
                            )}
                        </Formik>
